...
```{r data_manhattan}
manhattan <- read.csv("~/R/lecture-note-class-13-mirapolishook/manhattan.csv")
```
...
- Population: 1 bedroom apartment in Manhattan
...
We are 95% confident that the interval from 2305 to 2985 includes the true mean. 
...
We are 95% confident that the interval from 2162 to 2875 contains the true median of 1 bedroom apartment rents in Manhattan. 
...
**Interpretation**:
We are 95% confident that the true propotion of mice that died while not on the treatment is within 0.690 and 0.797. 
...
We are 95% confident that the true proportion of mice that lived while on the treatment is between 0.552 and 0.651. 
